...
import SPPaymentScreen from "./src/screens/serviceprov_screens/SPPaymentScreen";
...
export const StackNavigator = () => {
  const { user, isLoadingToken } = useAuth();
